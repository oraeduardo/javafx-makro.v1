...
public class UserListController implements Initializable, DataChangeListener {
	...
	@FXML
	public TableColumn<User, Integer> tableColumnId;
	
	@FXML
	public TableColumn<User, String> tableColumnName;

	@FXML
	public TableColumn<User, Boolean> tableColumnAdmin;
	
	@FXML
	public TableColumn<User, User> tableColumnEDIT;

	@FXML
	public TableColumn<User, User> tableColumnREMOVE;
	...
	private void createDialogForm(User obj, String absoluteName, Stage parenStage) {
		try {
